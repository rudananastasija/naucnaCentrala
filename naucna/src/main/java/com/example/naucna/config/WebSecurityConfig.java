...
import com.example.naucna.auth.RestAuthenticationEntryPoint;
import com.example.naucna.auth.TokenAuthenticationFilter;
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
			...
			.authorizeRequests()
				...
				.antMatchers("/magazin/**").permitAll()
				.antMatchers("/korisnici/**").permitAll()
				.antMatchers("/naucneOblasti/**").permitAll()
